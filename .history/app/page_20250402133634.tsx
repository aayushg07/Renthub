...
const HomePage = () => {
  ...
  <Image 
    src="/images/hero.avif"  // Updated path
    alt="Tech gadgets background" 
    fill  // This replaces width/height and makes it cover the container
    quality={100}
    priority  // Similar to loading="eager" but Next.js preferred
