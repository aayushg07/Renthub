    ...
    <div className="bg-white dark:bg-gray-900">
      ...
      <section className="relative py-32 px-6 text-white text-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-700/90 to-purple-700/90 dark:from-blue-900/90 dark:to-purple-900/90 z-0">
          <Image
            src="https://images.unsplash.com/photo-1602526432604-029a709e131c?q=80&w=2340&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        >
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-white/90">
            Rent high-end cameras, gaming consoles, laptops and more - flexible
        ...
        {showScrollIndicator && (
          ...
          >
            <div className="flex flex-col items-center">
              <span className="text-sm font-medium mb-1 text-white/80">
                Explore More
              </span>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              icon: (
                <FaDollarSign className="text-blue-600 dark:text-blue-400 text-4xl mb-4" />
              ),
              title: "Affordable Pricing",
              content:
                "Access premium tech at a fraction of retail prices with our flexible rental plans.",
            },
            {
              icon: (
                <FaLock className="text-purple-600 dark:text-purple-400 text-4xl mb-4" />
              ),
              title: "Secure Transactions",
              content:
                "Bank-level encryption and verified users ensure your rentals are always safe.",
            },
            {
              icon: (
                <FaBoxOpen className="text-green-600 dark:text-green-400 text-4xl mb-4" />
              ),
              title: "Massive Selection",
              content:
                "From DSLRs to VR headsets, we have got all the tech you need in one place.",
            },
          ].map((feature, index) => (
            <motion.div
              key={index}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-800">
        ...
        >
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Join thousands of creators, gamers and professionals who rent
            smarter.
          </p>
