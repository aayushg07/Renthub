...
const HomePage = () => {
  ...
  return (
    <div className="flex flex-col">
      {/* Modern Hero Section */}
      <header className="relative flex flex-col items-center justify-center text-centermd:py-32 px-6 min-h-screen text-white bg-gradient-to-br from-blue-800 to-blue-900 overflow-hidden">
        {/* Parallax Background */}
