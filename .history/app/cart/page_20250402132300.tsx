...
import { ScrollArea } from "@/app/components/ui/Scrollarea"; // Ensure this path is correct
      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <AnimatePresence mode="wait">
          {cartItems.length === 0 ? (
            ...
            >
              {/* Cart Items List */}
              <ScrollArea className="h-[400px]"> {/* Ensure ScrollArea is correctly implemented */}
                <Card>
                      ...
                      >
                        <div className="flex items-center space-x-5">
                          <div className="w-20 h-20 bg-gray-700 rounded-lg flex items-center justify-center overflow-hidden">
                            {item.image ? (
                              <Imae src={item.image} alt={item.name} className="object-cover w-full h-full" />
                            ) : (
