      ...
      <section className="relative py-32 px-6 text-white text-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button className="px-8 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white/10 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300">
                How It Works
              </button>
            </motion.div>
          </motion.div>
