...
export default function RecentlyViewed() {
  ...
  return (
    <div className="p-4 border rounded-lg shadow-md bg-white">
      <h2 className="text-xl font-bold mb-4 text-gray-800">Featured Items </h2>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {gadgets.map((gadget) => (
          <div key={gadget.id} className="border p-2 rounded hover:shadow-lg transition">
            <Image src={gadget.image} alt={gadget.name} fill className="w-full h-32 object-cover rounded" />
